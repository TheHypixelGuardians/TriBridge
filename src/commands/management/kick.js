...
function parseKickResponse(combined, username, guild) {
  ...
  if (
    lower.includes("cannot kick yourself") ||
    lower.includes("can't kick yourself")
  ) {
  ...
  if (
    lower.includes("same or higher rank") ||
    lower.includes("higher guild rank")
  ) {
