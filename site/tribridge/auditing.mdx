---
title: "Auditing"
description: "Audit trail for disguised messages with jump links."
---
A [global profile change](/tribridge/global-profile-change) deletes the original message and reposts it under somebody
...
`LOG_CHANNEL` instead — see [Configuration](/tribridge/configuration). Keep them separate: an audit channel full of
