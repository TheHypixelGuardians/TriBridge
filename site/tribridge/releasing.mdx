...
[`.github/workflows/wiki.yml`](https://github.com/TheHypixelGuardians/TriBridge/blob/master/.github/workflows/wiki.yml),
...
[docs/WIKI.md](https://github.com/TheHypixelGuardians/TriBridge/blob/master/docs/WIKI.md).
