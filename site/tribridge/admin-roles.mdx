---
title: "Admin Roles"
description: "Configure which Discord roles hold bot-admin access."
---
...
The list lives in `adminRolesConfig.json`. See [Config files](/tribridge/config-files).
...
`/requeststatus`. [Commands](/tribridge/commands) marks them all with 🔒.
