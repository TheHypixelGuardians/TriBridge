...
description: "How the bridge channel works for guild members in Discord."
---
...
[linked your Minecraft account](/tribridge/account-linking), it arrives under your **Minecraft** name instead, and your
...
See [Guild tags](/tribridge/guild-tags) for the full rules, including how to type a literal `!` and what the ❓ and 📡
reactions mean.
...
Everything else is a slash command. `/help` browses them by category; [Commands](/tribridge/commands) lists them all.
The ones you are most likely to want:

| Command                | Does                                                                 |
|------------------------|----------------------------------------------------------------------|
| `/link <username>`     | Bind your Minecraft account — see [Account linking](/tribridge/account-linking) |
...
| `/request`             | Suggest a feature — see [Feature requests](/tribridge/feature-requests)         |
...
- **A 📡 reaction** means you aimed at one guild with `!tag` and that guild's account is offline. Nothing was
  delivered.
- **Nothing at all, from anyone** — see [Troubleshooting](/tribridge/troubleshooting), and tell a server admin.

## Next

- [Guild tags](/tribridge/guild-tags)
- [Account linking](/tribridge/account-linking)
- [Commands](/tribridge/commands)
