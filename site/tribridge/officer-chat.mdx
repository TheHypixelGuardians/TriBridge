---
title: "Officer Chat"
description: "Two-way officer chat between Discord and Hypixel."
---
...
[guild tag](/tribridge/guild-tags). One channel is usually what you want — officers tend to be officers in both guilds,
...
[linked](/tribridge/account-linking)**, and your Discord name if not. Linking is worth doing here — officer chat is a
place where who said something usually matters.

## Replying to one guild

[Guild tags](/tribridge/guild-tags) work here just as they do in the bridge channel:
...
- **[Chat commands](/tribridge/networth) are not answered.** `!nw Notch` typed here, or in officer chat in-game, is just
  something an officer said. It does look like a tag, so it collects a ❓ — `!!nw Notch` avoids that.
- **Real names.** A running [global profile change](/tribridge/global-profile-change) does not apply in the officer
...
other's officer chat, the same way [guild chat can](/tribridge/guild-to-guild-bridging):
...
[guild-to-guild bridging](/tribridge/guild-to-guild-bridging) applies — symmetric, off by default, takes two guilds,
