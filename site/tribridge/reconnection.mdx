---
title: "Reconnection"
description: "How dropped Minecraft accounts reconnect automatically."
---
...
guild, or to the console. Never to a shared channel — see [Hypixel guilds](/tribridge/hypixel-guilds).
