...
description: "Link your Discord account to your Minecraft name for relay attribution."
---
...
- **You may be given a role**, if the server has one configured — see [Link role](/tribridge/link-role).
...
- **If the bot is missing a permission**, linking still works — your messages just relay the ordinary way,
  without the head and name, until an admin fixes it. See [Permissions](/tribridge/permissions).

## Next

- [Using the bridge](/tribridge/using-the-bridge)
- [Networth](/tribridge/networth)
- [Link role](/tribridge/link-role) — for whoever configures the role
