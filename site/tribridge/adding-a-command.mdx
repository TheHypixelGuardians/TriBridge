...
4. **The docs and this wiki** —
   [docs/FEATURES.md](https://github.com/TheHypixelGuardians/TriBridge/blob/master/docs/FEATURES.md) is canonical; the
   wiki page restates it for its reader. A new command always touches [Commands](/tribridge/commands), which is meant to
   be exhaustive. New config file? [Config files](/tribridge/config-files). New permission?
   [Permissions](/tribridge/permissions).
