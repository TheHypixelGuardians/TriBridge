---
title: "Networth"
description: "Look up SkyBlock networth from chat or slash commands."
---
...
With no username it uses your [linked account](/tribridge/account-linking).
...
[guild tags](/tribridge/guild-tags) use.
