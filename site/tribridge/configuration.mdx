---
title: "Configuration"
description: "Environment variables and first-run setup."
---
...
[Config files](/tribridge/config-files).
...
so on startup and carries on. Add and change accounts with [`/guilds`](/tribridge/hypixel-guilds), not by editing this.
...
| What                              | Command                           | Page                                               |
|-----------------------------------|-----------------------------------|----------------------------------------------------|
| Which Hypixel guilds are bridged  | `/guilds`                         | [Hypixel guilds](/tribridge/hypixel-guilds)                   |
| Guild-to-guild chat sharing       | `/guilds edit … crossbridge:True` | [Guild-to-guild bridging](/tribridge/guild-to-guild-bridging) |
| Who counts as a bot admin         | `/adminrole`                      | [Admin roles](/tribridge/admin-roles)                         |
| The role given to linked users    | `/linkrole`                       | [Link role](/tribridge/link-role)                             |
| Where audit entries go            | `/auditchannel`                   | [Auditing](/tribridge/auditing)                               |
| Where feature requests are posted | `/requestchannel`                 | [Feature requests](/tribridge/feature-requests)               |
| Per-guild log and audit channels  | `/guilds edit`                    | [Hypixel guilds](/tribridge/hypixel-guilds)                   |
