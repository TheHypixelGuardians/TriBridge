---
title: "Guild Tags"
description: "Target one Hypixel guild with !tag prefixes in the bridge channel."
---
...
[`/guilds`](/tribridge/hypixel-guilds). `/guilds list` shows them, and incoming guild chat carries the tag next to the
...
Tags work the same way in an [officer channel](/tribridge/officer-chat) that more than one guild shares, with one
...
- **📡 — aimed at nobody.** You used a real tag, but that guild's Minecraft account is offline right now.
  Nothing was delivered. Try again when [`/ping`](/tribridge/commands) shows it back up.
...
both [guild tags](/tribridge/guild-tags) and [chat commands](/tribridge/networth).

## Next

- [Using the bridge](/tribridge/using-the-bridge)
- [Guild-to-guild bridging](/tribridge/guild-to-guild-bridging) — how the guilds talk to each other directly
