---
title: "Link Role"
description: "Optional Discord role handed out to linked users."
---
An optional Discord role handed out automatically to everyone with a
[linked Minecraft account](/tribridge/account-linking).
...
**Server Members** intent. See [Permissions](/tribridge/permissions).
