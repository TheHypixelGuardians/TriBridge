---
title: "Hypixel Guilds"
description: "Register and manage Hypixel guilds with /guilds."
---
...
| `officerChannelId`   | Optional two-way [officer chat](/tribridge/officer-chat) channel, shareable between guilds. No fallback — unset is off     |
| `enabled`            | `false` disconnects the guild without removing it                                                               |
| `crossBridge`        | `true` shares chat with the other cross-bridged guilds — see [Guild-to-guild bridging](/tribridge/guild-to-guild-bridging) |
| `crossBridgeOfficer` | `true` shares [officer chat](/tribridge/officer-chat) in-game with the other guilds that have it on                        |
...
back to the global one again, and **Officer channel** switches [officer chat](/tribridge/officer-chat) off, since that
...
> Restrict it with Discord's channel permissions before setting it — see [Officer chat](/tribridge/officer-chat).
...
part in [guild-to-guild bridging](/tribridge/guild-to-guild-bridging) and a 🛡️ on those sharing
[officer chat](/tribridge/officer-chat). Account addresses are masked.
...
- [Guild-to-guild bridging](/tribridge/guild-to-guild-bridging)
- [Officer chat](/tribridge/officer-chat)
- [Reconnection](/tribridge/reconnection)
- [Guild tags](/tribridge/guild-tags)
