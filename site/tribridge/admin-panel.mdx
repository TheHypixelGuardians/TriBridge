---
title: "Admin Panel"
description: "Use /adminpanel to toggle admin features from Discord."
---
```
/adminpanel
```
...
Bot-admin only. See [Admin roles](/tribridge/admin-roles).

## The main view

| Button             | Does                                                                |
|--------------------|---------------------------------------------------------------------|
| **Global Profile** | Set up a [global profile change](/tribridge/global-profile-change)             |
...
[Adding a command](/tribridge/adding-a-command) for how a new one is wired in, and keep the audit trail in mind —
anything that acts on other people's messages should leave a record the way the global profile change does.

## Next

- [Global profile change](/tribridge/global-profile-change)
