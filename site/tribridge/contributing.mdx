---
title: "Contributing"
description: "Commit conventions and what makes a good change."
---
## Getting set up
...
against fakes — see [Architecture](/tribridge/architecture).
...
[docs/COMMIT_STRUCTURE.md](https://github.com/TheHypixelGuardians/TriBridge/blob/master/docs/COMMIT_STRUCTURE.md).

## What a good change looks like

- **It carries its own documentation.** The changelog entry, the README row and the Mintlify page ship in the
  same commit as the code. See the checklist in [Adding a command](/tribridge/adding-a-command).
...
- **From inside the server:** `/request` — see [Feature requests](/tribridge/feature-requests).
