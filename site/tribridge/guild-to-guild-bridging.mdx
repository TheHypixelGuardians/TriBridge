---
title: "Guild to Guild Bridging"
description: "Share guild chat directly between bridged Hypixel guilds in-game."
---
...
- **[Chat commands](/tribridge/networth) are not forwarded either.** The answer carries the question with it, so nothing
  is lost.
- **Real names.** A running [global profile change](/tribridge/global-profile-change) does not rename forwarded chat. Its
